...
package kuce15.myassistant.Task;
...
public class AlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void setRepeatAlarmSunday(Context context, Calendar calendar, int ID, long RepeatTime) {
        mAlarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
        ...
        // Start alarm using initial notification time and repeat interval time
        mAlarmManager.setRepeating(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(), AlarmManager.INTERVAL_DAY * 7, mPendingIntent);
