...
public class MondayAdd extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    MondayAdd(Context ctx)
    {
        this.ctx=ctx;
    }


    MondayDatabase sundayDatabase;
    ...
    public void saveReminder() {
        ...
        MondayDatabase rb = new MondayDatabase(this);

        // Creating Reminder
        int ID = rb.addReminder(new MondayReminder(sCourse, sCourseInstructuor, sTime, sON));
