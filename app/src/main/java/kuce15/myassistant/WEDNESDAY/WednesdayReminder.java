 ...
 */
public class WednesdayReminder {
    ...
    public WednesdayReminder(int sID, String sCourse, String sCourseinstructor, String sTime, String sNotification){
          /* sID = ID;
        sCourse = course;
    ...
    public WednesdayReminder(String course, String courseinstructor, String time, String notification){
        sCourse = course;
        sCourseInstructor = courseinstructor;
        sTime = time;
        sNotification = notification;
