...
public class ThursdayReminder {
    ...
    public ThursdayReminder(int sID, String sCourse, String sCourseinstructor, String sTime, String sNotification){
       /* sID = ID;
        sCourse = course;
    ...
    public ThursdayReminder(String course, String courseinstructor, String time, String notification){
        sCourse = course;
        sCourseInstructor = courseinstructor;
        sTime = time;
        sNotification = notification;
