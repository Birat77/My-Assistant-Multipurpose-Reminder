...
public class FridayAdd extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    FridayAdd(Context ctx)
    {
        this.ctx=ctx;
    }


    FridayDatabase sundayDatabase;
    ...
    public void saveReminder() {
        ...
        FridayDatabase rb = new FridayDatabase(this);

        // Creating Reminder
        int ID = rb.addReminder(new FridayReminder(sCourse, sCourseInstructuor, sTime, sON));
