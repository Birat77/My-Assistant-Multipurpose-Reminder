...
/**
 * Created by Shoaib on 2/25/2017.
 */

public class sundayadd extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
        ...
        sundayadd (Context ctx)
        {
            this.ctx=ctx;
        }


        SundayDatabase sundayDatabase;
...
*/
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_sundayadd);
        ...
        public void saveReminder() {
            ...
            SundayDatabase rb = new SundayDatabase(this);

            // Creating Reminder
            int ID = rb.addReminder(new SundayReminder(sCourse, sCourseInstructuor, sTime, sON));
