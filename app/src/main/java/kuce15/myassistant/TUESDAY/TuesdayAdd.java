...
public class TuesdayAdd extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    TuesdayAdd(Context ctx)
    {
        this.ctx=ctx;
    }


    TuesdayDatabase sundayDatabase;
    ...
    public void saveReminder() {
        ...
        TuesdayDatabase rb = new TuesdayDatabase(this);

        // Creating Reminder
        int ID = rb.addReminder(new TuesdayReminder(sCourse, sCourseInstructuor, sTime, sON));
