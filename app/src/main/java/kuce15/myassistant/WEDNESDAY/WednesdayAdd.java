...
public class WednesdayAdd extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    WednesdayAdd(Context ctx)
    {
        this.ctx=ctx;
    }


    WednesdayDatabase sundayDatabase;
    ...
    public void saveReminder() {
        ...
        WednesdayDatabase rb = new WednesdayDatabase(this);

        // Creating Reminder
        int ID = rb.addReminder(new WednesdayReminder(sCourse, sCourseInstructuor, sTime, sON));
